...
import in.matka.ns.Adapter.AllHistoryAdapter;
import in.matka.ns.Adapter.FundsHistryAdapter;
import in.matka.ns.AppController;
import in.matka.ns.Model.HistryModel;
...
import static in.matka.ns.Config.BaseUrls.URL_FUND_HISTORY;
import static in.matka.ns.Config.BaseUrls.URL_GET_HISTORY;
import static in.matka.ns.Config.BaseUrls.URL_STARLINE_HISTORY;
                ...
                try {
                    ...
                    if (res) {
                        ...
                        if (req_list.size ( ) > 0) {
                           ...
                           // if((no_history.getVisibility() == View.GONE)){
                                no_history.setVisibility (View.VISIBLE);
                            //}
