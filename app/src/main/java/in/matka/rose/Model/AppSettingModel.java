...
public class AppSettingModel {
    ...
    String whatsapp_no,whatsapp_msg,starline_name;
    ...
    public String getStarline_name() {
        return starline_name;
    }

    public void setStarline_name(String starline_name) {
        this.starline_name = starline_name;
    }
}
