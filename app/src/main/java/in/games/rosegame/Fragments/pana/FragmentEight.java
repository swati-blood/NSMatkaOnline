package in.games.rosegame.Fragments.pana;
...
import in.games.rosegame.Adapter.SigleDoublePanaAdapter;
...
import static in.games.rosegame.Activity.PanaActivity.game_names;
import static in.games.rosegame.Activity.PanaActivity.total;
...
public class FragmentEight extends Fragment {
    ...
    public void onStart() {
        ...
        if (game_names.equals("Single Pana"))
        {
            sigleDoublePanaAdapter = new SigleDoublePanaAdapter(single_list.subList(84,96),getActivity(),8,bet_list,game_names);

        }
        else if (game_names.equals("Double Pana"))
        {
            sigleDoublePanaAdapter = new SigleDoublePanaAdapter(single_list.subList(70,80),getActivity(),8,bet_list,game_names);
